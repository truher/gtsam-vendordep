...
public class BatchFixedLagSmootherTest {
    ...
    void testExample() {
        ...
        // // Set up parameters
        // SharedDiagonal odometerNoise = noiseModel::Diagonal::Sigmas(Vector2(0.1,
        // 0.1));
        ...
        // size_t factorIndex = 6; // any index that does not break connectivity of the
        // graph
    ...
    void testEnforceConsistency() {
        ...
        // BatchFixedLagSmoother smootherOn(3.0, params, true); // enforceConsistency =
        // true
        // BatchFixedLagSmoother smootherOff(3.0, params, false); // enforceConsistency
        // = false
        ...
        // // but may differ because consistency enforcement constrains the
        // optimization.
