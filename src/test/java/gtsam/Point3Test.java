...
public class Point3Test {
    ...
    void testLie() throws Throwable {
        ...
        // EXPECT(assert_equal(Point3(3, 3, 3), traits<Point3>::Between(p1, p2, H1,
        // H2)));
        // EXPECT(assert_equal(-I_3x3, H1));
        // EXPECT(assert_equal(I_3x3, H2));

        // EXPECT(assert_equal(Point3(5, 7, 9), traits<Point3>::Retract(p1,
        // Vector3(4,5,6))));
    ...
    void testarithmetic() {
        ...
        // CHECK(assert_equal<Point3>(Point3(2, 5, 6), Point3(1, 4, 5) + Point3(1, 1,
        // 1)));
        // CHECK(assert_equal<Point3>(Point3(0, 3, 4), Point3(1, 4, 5) - Point3(1, 1,
        // 1)));
    ...
    void testdot() {
        ...
        // {
        // gtsam::dot(p, q, H1, H2);
        // EXPECT(assert_equal(numericalDerivative21<double,Point3>(f, p, q), H1,
        // 1e-9));
        // EXPECT(assert_equal(numericalDerivative22<double,Point3>(f, p, q), H2,
        // 1e-9));
        // }
        // {
        // gtsam::dot(p, r, H1, H2);
        // EXPECT(assert_equal(numericalDerivative21<double,Point3>(f, p, r), H1,
        // 1e-9));
        // EXPECT(assert_equal(numericalDerivative22<double,Point3>(f, p, r), H2,
        // 1e-9));
        // }
        // {
        // gtsam::dot(p, t, H1, H2);
        // EXPECT(assert_equal(numericalDerivative21<double,Point3>(f, p, t), H1,
        // 1e-9));
        // EXPECT(assert_equal(numericalDerivative22<double,Point3>(f, p, t), H2,
        // 1e-9));
        // }
    }
    ...
    void testcross2() {
        ...
        // EXPECT(assert_equal(numericalDerivative21<Point3,Point3>(f, p, q), H1,
        // 1e-9));
        // EXPECT(assert_equal(numericalDerivative22<Point3,Point3>(f, p, q), H2,
        // 1e-9));
        // }
        // {
        // gtsam::cross(p, r, H1, H2);
        // EXPECT(assert_equal(numericalDerivative21<Point3,Point3>(f, p, r), H1,
        // 1e-9));
        // EXPECT(assert_equal(numericalDerivative22<Point3,Point3>(f, p, r), H2,
        // 1e-9));
        // }
    }
