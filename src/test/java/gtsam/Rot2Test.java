...
public class Rot2Test {
    ...
    @Test
    void testcompose() {
        // CHECK(assert_equal(Rot2::fromAngle(0.45),
        // Rot2::fromAngle(0.2)*Rot2::fromAngle(0.25)));
        // CHECK(assert_equal(Rot2::fromAngle(0.45),
        // Rot2::fromAngle(0.25)*Rot2::fromAngle(0.2)));
    ...
    @Test
    void testbetween() {
        // CHECK(assert_equal(Rot2::fromAngle(0.05),
