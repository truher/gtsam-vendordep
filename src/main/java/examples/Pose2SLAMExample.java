...
public class Pose2SLAMExample {
    ...
    public static void main(String args[]) throws Throwable {
         ...
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(new Key(1), new Key(2),
         * new Pose2(2, 0, 0), model));
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(new Key(2), new Key(3),
         * new Pose2(2, 0, Math.PI/2), model));
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(new Key(3), new Key(4),
         * new Pose2(2, 0, Math.PI/2), model));
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(new Key(4), new Key(5),
         * new Pose2(2, 0, Math.PI/2), model));
         * 
         * // 2c. Add the loop closure constraint
         * // This factor encodes the fact that we have returned to the same pose. In
         * real systems,
         * // these constraints may be identified in many ways, such as appearance-based
         * techniques
         * // with camera images. We will use another Between Factor to enforce this
         * constraint:
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(5, 2, new Pose2(2, 0,
         * Math.PI/2), model);
         * graph.print("\nFactor Graph:\n"); // print
         * 
         ...
         * GaussNewtonOptimizer optimizer = new GaussNewtonOptimizer(graph,
