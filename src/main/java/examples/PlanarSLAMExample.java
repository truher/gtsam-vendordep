...
public class PlanarSLAMExample {
    ...
    public static void main(String args[]) throws Throwable {
         ...
         * var priorNoise = Diagonal.Sigmas( new Vector3(0.3, 0.3, 0.1)); // 30cm std on
         * x,y, 0.1 rad on theta
         * graph.addPrior(x1, prior, priorNoise); // add directly to graph
         * 
         * // Add two odometry factors
         * Pose2 odometry = new Pose2(2.0, 0.0, 0.0);
         * // create a measurement for both factors (the same in this case)
         * var odometryNoise = Diagonal.Sigmas( new Vector3(0.2, 0.2, 0.1)); // 20cm std
         * on x,y, 0.1 rad on theta
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(x1, x2, odometry,
         * odometryNoise));
         * graph.add(BetweenFactorPose2.newBetweenFactorPose2(x2, x3, odometry,
         * odometryNoise));
         * 
         * // Add Range-Bearing measurements to two different landmarks
         * // create a noise model for the landmark measurements
         * var measurementNoise = Diagonal.Sigmas( new Vector2(0.1, 0.2)); // 0.1 rad
         * std on bearing, 20cm on range
         ...
         * graph.add(BearingRangeFactor<Pose2, Point2> >(x1, l1, bearing11, range11,
         * measurementNoise));
         * graph.add(BearingRangeFactor<Pose2, Point2> >(x2, l1, bearing21, range21,
         * measurementNoise));
         * graph.add(BearingRangeFactor<Pose2, Point2> >(x3, l2, bearing32, range32,
         * measurementNoise));
         * 
         * // Print
         ...
         * LevenbergMarquardtOptimizer(graph, initialEstimate);
